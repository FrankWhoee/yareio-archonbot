...
if(tick == 0){
	...
	memory = {star: (d1>d2 ? star_a1c : star_zxq)}
}
report = role_report()
...
function assign_role(s){
	report = role_report()
	if(star_p89.energy > 0 && report.harvesters > 100){
		s.set_mark("attacker")
